...
namespace
{
	...
	const std::string kSpritePath("TextBox.bmp");
...
Player::Health::Health(Graphics& graphics) : 
	...
	current_health_(6),
	health_bar_sprite_(
		graphics, kSpritePath, units::gameToPixel(kHealthBarSourceX), 
		units::gameToPixel(kHealthBarSourceY), 
		units::gameToPixel(kHealthBarSourceWidth), units::gameToPixel(kHealthBarSourceHeight)),
	health_fill_sprite_(
		graphics, kSpritePath, units::gameToPixel(kHealthFillSourceX),
		units::gameToPixel(kHealthFillSourceY),
		units::gameToPixel(kMaxFillWidth), units::gameToPixel(kHealthFillSourceHeight)),
	damage_fill_sprite_(
		graphics, kSpritePath, units::gameToPixel(kHealthDamageSourceX),
		units::gameToPixel(kHealthDamageSourceY),
		units::gameToPixel(kMaxFillWidth), units::gameToPixel(kHealthDamageSourceHeight))
{
